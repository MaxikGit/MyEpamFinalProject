...
/*!40000 ALTER TABLE `dish`
    DISABLE KEYS */;
INSERT INTO `dish`
VALUES (1, 'Шуба', 070.30, 'none', 1, 'salad_fur_coat.webp'),
       (2, 'Bulgarian', 050.20, 'none', 1, 'bulgarian.webp'),
       (3, 'Grilled chicken with charred pineapple salad', 020.50, 'none', 1,
        'grilled_chicken_with_charred_pineapple_salad.webp'),
       (4, 'Печеня', 170.50, 'none', 2, 'zharkoe.webp'),
       (5, 'Fried tune', 050.50, 'none', 2, 'fried_tune_new.webp'),
       (6, 'Perfect pork belly', 220.10, 'none', 2, 'perfect_pork_belly.webp'),
       (7, 'Gunpowder lamb', 270.25, 'none', 2, 'gunpowder_lamb.webp'),
       (8, 'BBQ british ribs', 130.20, 'none', 3, 'bbq_british_ribs.webp'),
       (9, 'Шашлик з ошийка', 225.50, 'none', 3, 'shashlyk_z_oshijka.webp'),
       (10, 'Butterflied prawn skewers', 320.10, 'none', 3, 'butterflied_prawn_skewers.webp'),
       (11, 'Whole burnt aubergine', 070.25, 'none', 3, 'whole_burnt_aubergine.webp'),
       (12, 'Вода', 010.00, 'none', 4, 'bottle_of_water.webp'),
