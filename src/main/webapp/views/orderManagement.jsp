                ...
                <div class="w3-container w3-margin">
                    <table class="w3-table-all w3-hoverable w3-center w3-light-blue w3-margin-bottom">
                        <tr class="w3-card-2 w3-cell-row w3-hover-none w3-light-blue">
                            ...
                            <th class="w3-cell-middle w3-col s1 "></th>
                        </tr>
                        ...
                        <c:forEach var="orderData" items="${orderManagement}" varStatus="num">
                            <tr class="w3-card-2 w3-cell-row">
                                ...
                                <td class="w3-cell-middle w3-col s1 w3-center">
                                    <mytag:DeleteForeverButton commandName="management" idToDelete="${orderData.custom.id}"/>
<%--                                    <a href="${pageContext.request.contextPath}/AuthorisationServlet?action=management&deleteId=${orderData.custom.id}">--%>
...
<%--            Adding two Buttons to react--%>
        ...
        <c:if test="${orderManagement == null}">
            <div class="w3-panel w3-pale-yellow w3-display-middle w3-display-container w3-card-4 w3-round">
