...
<div class="w3-container w3-light-blue w3-border-light-blue w3-center">
    <h3><mytag:OrderCreatedDate custom="${orderDataManagement.custom}"/>
    </h3>
</div>
...
<%--            Adding two Buttons to react--%>
            ...
            <div class="w3-cell-row w3-half w3-right">
                <h5>
                    ...
                    <button name="action" value="orderEditManagement" type="submit"
...
<div class="w3-container w3-grey w3-opacity w3-right-align w3-padding w3-display-container">
    <button class="w3-btn w3-round-large" onclick="location.href='${pageContext.request.contextPath}/AuthorisationServlet?action=management'">
